<script lang="ts">
	...
	function downloadGPX() {
		...
		a.href = url;
		a.download = `${activeRound.slug}.waypoints.gpx`;
				...
				<div class="inline-flex flex-col">
					{#if activeRound.link}
						...
						>
							...
							<span class="mx-auto"><i>{cleanUrlForDisplay(activeRound.link)}</i></span>
						</a>
					{/if}
					<button
					...
					>
						...
						<span class="mx-auto">Download GPX Waypoints</span>
					</button>
				</div>
			</div>
			<hr class="my-3" />
